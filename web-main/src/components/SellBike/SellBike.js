...
const useStyles = makeStyles((theme) => ({
  ...
  sellActive: {
    ...
    filter:
      "progid:DXImageTransform.Microsoft.gradient( startColorstr='#fc8a19', endColorstr='#f06425',GradientType=1 )",
  },
  whichCar: {
    fontSize: "20px",
    marginTop: "20px",
      ...
      <Container maxWidth="lg">
        <div className={classes.carBuild}>
          <div className={classes.textDiv}>
            ...
            <div className={classes.whichCar}>What you want to sell?</div>
